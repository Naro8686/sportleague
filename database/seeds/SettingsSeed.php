...
class SettingsSeed extends Seeder
{
    ...
    public function run()
    {
        $texts = [
            ...
            ['title' => 'Reset', 'content' => '{"hello":"Hello!","second":"You are receiving this email because we received a password reset request for your account.","button":"Reset Password","bottom":"If you did not request a password reset, no further action is required.","regards":"Regards","manager":"League Manager"}'],
            ['title' => 'logo', 'content' => 'white_logo1582817779.png'],
            ['title' => 'black_logo', 'content' => 'black_logo1582817779.png'],
        ];
